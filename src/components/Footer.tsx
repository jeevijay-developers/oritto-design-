      ...
      <div className="max-w-7xl mx-auto px-4 py-16">
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            <div>
              <h3 className="text-2xl font-bold text-red-500 mb-2">oriito</h3>
            ...
            <p className="text-gray-400 leading-relaxed">
              ...
              Energy efficient, long-lasting, and eco-friendly lighting for every need.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-400">
              <li><a href="#" className="hover:text-red-500 transition-colors">Installation Guide</a></li>
              <li><a href="#" className="hover:text-red-500 transition-colors">Warranty Information</a></li>
              <li><a href="#" className="hover:text-red-500 transition-colors">Technical Support</a></li>
              <li><a href="#" className="hover:text-red-500 transition-colors">Product Manuals</a></li>
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-400">
              <li><a href="#" className="hover:text-red-500 transition-colors">Lighting Tips</a></li>
              <li><a href="#" className="hover:text-red-500 transition-colors">Energy Saving Guide</a></li>
              <li><a href="#" className="hover:text-red-500 transition-colors">Industry News</a></li>
              <li><a href="#" className="hover:text-red-500 transition-colors">Case Studies</a></li>
              <li><a href="#" className="hover:text-red-500 transition-colors">Innovation Updates</a></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-400">
              ...
              <li><a href="#" className="hover:text-red-500 transition-colors">Quality Standards</a></li>
              <li><a href="#" className="hover:text-red-500 transition-colors">Certifications</a></li>
          ...
          <div className="grid md:grid-cols-3 gap-6">
            <div className="flex items-center space-x-3">
              ...
              <div>
                ...
                <p className="text-gray-400 text-sm">123 LED Street, Tech City, TC 12345</p>
              </div>
            </div>
            <div className="flex items-center space-x-3">
              ...
              <div>
                ...
                <p className="text-gray-400 text-sm">+91 000 12345 / +91 000 56789</p>
              </div>
            </div>
            <div className="flex items-center space-x-3">
              ...
              <div>
                ...
                <p className="text-gray-400 text-sm">info@oriito.com</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-4 py-6">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-gray-400 text-sm">
              © 2024 Oriito LED Lights. All rights reserved.
            </p>
