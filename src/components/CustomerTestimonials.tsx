  ...
  const testimonials = [
    {
      ...
      rating: 5,
      comment:
        "Outstanding LED lights with excellent brightness and durability. The customer service team was very helpful throughout the installation process.",
      avatar:
    ...
    },
    {
      ...
      rating: 5,
      comment:
        "oritto LED lights transformed our office space completely. Energy efficient and cost-effective solution that exceeded our expectations.",
      avatar:
    ...
    },
    {
      ...
      rating: 5,
      comment:
        "Professional quality products with reliable performance. I recommend oritto to all my clients for their lighting needs.",
      avatar:
      ...
      <div className="max-w-7xl mx-auto px-4">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-gray-600 max-w-2xl mx-auto">
            ...
            with oritto LED lighting solutions
          </p>
        </div>
        ...
        <div className="mt-16 bg-gradient-to-r from-red-500 to-orange-500 rounded-2xl p-8 text-center">
          ...
          <p className="text-red-100 mb-6 max-w-2xl mx-auto">
            ...
            products, special offers, and lighting tips
          </p>
